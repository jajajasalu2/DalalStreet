    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <br/>Dividend: {{Form::number('dividend',$company_dividend->dividend,['step'=>0.01,'class'=>'form_control'])}}
                ...
                <br/>Dividend: {{Form::number('dividend',0,['step'=>0.01,'class'=>'form_control'])}}
                ...
                <br/>Bonus: {{Form::number('bonus',$company_bonus->bonus,['step'=>0.01,'class'=>'form_control'])}}
                ...
                <br/>Bonus: {{Form::number('bonus',0,['step'=>0.01,'class'=>'form_control'])}}
